...
import { createNewBlogPost, deleteBlogPostById, getAllBlogPost, getBlogPostById, updateBlogPost } from "./blog.controller"
...
blogRouter.delete("/blog/:id", deleteBlogPostById)
